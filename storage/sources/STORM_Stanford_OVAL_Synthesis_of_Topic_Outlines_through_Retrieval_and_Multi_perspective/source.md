...
We define metrics and collect the FreshWiki dataset to evaluate the pre-writing stage quality. Our results demonstrate a correlation between the pre-writing quality and the final article quality.

Check out the video below to see how STORM works:

## Instructing LM to Ask Good Questions
...
4. **Error Analysis:** Through careful error analysis, we find the major challenge stems from red herrings (establishing shaky links or incorporating irrelevant content) rather than widely discussed factual hallucination issue.